...
**Dashboard overview.** Active sessions with compact live stat trackers, completed runs, table-scoped search filters, token volume by model, and a live activity timeline in one view.
