...
func Dashboard(data views.DashboardData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<script>\n\t\tdocument.body.setAttribute('data-page', 'dashboard');\n\t\t(function() {\n\t\t\ttry {\n\t\t\t\tif (localStorage.getItem('beacon-timeline-width') === '0') {\n\t\t\t\t\tdocument.documentElement.setAttribute('data-beacon-timeline-collapsed', 'true');\n\t\t\t\t}\n\t\t\t} catch (err) {}\n\t\t})();\n\t\t</script> <div id=\"dashboard-wrap\" class=\"dashboard-shell\"><div id=\"dashboard-main\" class=\"dashboard-main\"><header class=\"dashboard-header\" aria-labelledby=\"dashboard-title\"><div class=\"dashboard-header-title\"><div class=\"dashboard-name-control\" data-dashboard-name-control data-dashboard-default-name=\"")
			if templ_7745c5c3_Err != nil {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/pages/dashboard.templ`, Line: 27, Col: 55}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/pages/dashboard.templ`, Line: 28, Col: 59}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/pages/dashboard.templ`, Line: 35, Col: 133}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/pages/dashboard.templ`, Line: 37, Col: 138}
			}
