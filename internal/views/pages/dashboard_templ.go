...
func Dashboard(data views.DashboardData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<script>\n\t\tdocument.body.setAttribute('data-page', 'dashboard');\n\t\t(function() {\n\t\t\ttry {\n\t\t\t\tif (localStorage.getItem('beacon-timeline-width') === '0') {\n\t\t\t\t\tdocument.documentElement.setAttribute('data-beacon-timeline-collapsed', 'true');\n\t\t\t\t}\n\t\t\t} catch (err) {}\n\t\t})();\n\t\t</script> <div id=\"dashboard-wrap\" class=\"flex h-[calc(100vh-3rem)]\"><!-- Main Content Area --><div id=\"dashboard-main\" class=\"flex-1 flex flex-col gap-6 overflow-y-auto min-w-0 pr-0\"><div class=\"space-y-6\"><section class=\"space-y-4\"><div class=\"flex flex-wrap items-center justify-between gap-3\"><div class=\"min-w-0\"><div class=\"dashboard-name-control\" data-dashboard-name-control data-dashboard-default-name=\"")
			if templ_7745c5c3_Err != nil {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/pages/dashboard.templ`, Line: 30, Col: 57}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/pages/dashboard.templ`, Line: 31, Col: 61}
			}
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var4))
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 3, "\"><h1 id=\"dashboard-title\" data-dashboard-title class=\"dashboard-title text-xl font-semibold text-gray-100\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/pages/dashboard.templ`, Line: 33, Col: 135}
			}
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var5))
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 4, "</h1><button type=\"button\" id=\"dashboard-name-edit\" class=\"dashboard-name-btn\" aria-label=\"Edit dashboard name\" aria-controls=\"dashboard-name-input\" title=\"Edit dashboard name\"><svg aria-hidden=\"true\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M16.9 4.6a2.1 2.1 0 013 3L8.7 18.8l-4 .8.8-4L16.9 4.6z\"></path></svg></button> <label for=\"dashboard-name-input\" class=\"sr-only\">Dashboard name</label> <input id=\"dashboard-name-input\" data-dashboard-name-input type=\"text\" autocomplete=\"off\" maxlength=\"80\" value=\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/pages/dashboard.templ`, Line: 40, Col: 140}
			}
